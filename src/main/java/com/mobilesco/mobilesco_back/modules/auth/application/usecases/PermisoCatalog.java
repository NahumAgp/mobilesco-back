...
public final class PermisoCatalog {
    ...
    public static final List<Definition> DEFINITIONS = List.of(
            ...
            new Definition("VIEW_WAREHOUSE_REQUISITIONS", "Ver requisiciones de almacén", "Almacen", "Requisiciones", "Crear y consultar solicitudes de insumos.", "/almacen/requisiciones", "VIEW"),

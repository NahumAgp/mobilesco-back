...
public final class PermisoCatalog {
    ...
    public static final List<Definition> DEFINITIONS = List.of(
            ...
            view("VIEW_ASSISTED_PROCUREMENT", "Ver abastecimiento asistido", "Compras", "Abastecimiento asistido", "/compras/abastecimiento"),
            action("ACTION_ASSISTED_PROCUREMENT_DRAFTS", "Generar borradores desde abastecimiento asistido", "Compras", "Abastecimiento asistido", "/compras/abastecimiento", "VIEW_ASSISTED_PROCUREMENT"),
            ...
            view("VIEW_INPUT_SETS", "Ver conjuntos de insumos", "Almacén", "Conjuntos de insumos", "/insumos"),
            action("ACTION_INPUT_SETS_CREATE", "Crear conjuntos de insumos", "Almacén", "Conjuntos de insumos", "/insumos", "VIEW_INPUT_SETS"),
            action("ACTION_INPUT_SETS_EDIT", "Editar conjuntos de insumos", "Almacén", "Conjuntos de insumos", "/insumos", "VIEW_INPUT_SETS"),
    ...
    public static final Map<String, Set<String>> DEFAULT_ROLE_PERMISSIONS = Map.ofEntries(
            ...
            Map.entry("ASISTENTE_GERENCIAL", Set.of("VIEW_DASHBOARD", "VIEW_EMPLOYEES", "VIEW_SUPPLIERS", "VIEW_PRODUCTS", "VIEW_PRODUCT_CATALOG", "VIEW_PURCHASES", "VIEW_ASSISTED_PROCUREMENT", "VIEW_CUSTOMERS", "VIEW_QUOTES")),
            ...
            Map.entry("JEFE_ALMACEN", Set.of("VIEW_DASHBOARD", "VIEW_INVENTORY", "VIEW_INPUT_SETS", "VIEW_INPUT_TYPES", "VIEW_MEASURE_UNITS", "VIEW_INVENTORY_OUTPUTS", "VIEW_WAREHOUSE_REQUISITIONS", "VIEW_WAREHOUSE_RECEIPTS", "VIEW_KARDEX", "VIEW_PURCHASES", "VIEW_ASSISTED_PROCUREMENT", "VIEW_PRODUCTS", "VIEW_PRODUCT_CATALOG", "ACTION_STOCK_ADJUSTMENTS", "VIEW_PRODUCTION_ORDERS", "ACTION_PRODUCTION_MATERIAL_ISSUE")),
            Map.entry("JEFE_LOGISTICA", Set.of("VIEW_DASHBOARD", "VIEW_INVENTORY", "VIEW_INPUT_SETS", "VIEW_INVENTORY_OUTPUTS", "VIEW_KARDEX", "VIEW_PRODUCTS", "VIEW_PRODUCT_CATALOG")),
    ...
    public static final Map<String, Set<String>> LEGACY_EXPANSIONS = Map.ofEntries(
            ...
            Map.entry("VIEW_PURCHASES", Set.of("ACTION_PURCHASES_CREATE", "ACTION_PURCHASES_EDIT", "ACTION_PURCHASES_DELETE", "ACTION_PURCHASES_RECEIVE", "VIEW_ASSISTED_PROCUREMENT", "ACTION_ASSISTED_PROCUREMENT_DRAFTS", "VIEW_ACCOUNTS_PAYABLE", "ACTION_ACCOUNTS_PAYABLE_EDIT", "VIEW_WAREHOUSE_RECEIPTS", "ACTION_WAREHOUSE_RECEIPTS_RECEIVE")),
